...
class ESS:
    ...
    def run_network(self, i, total_demand, pv_generation_profile, wind_generation_profile, load_factor_profile):
        ...
        #ToDo: ich muss den profit der agenten anders berechnen...
        #z.b. der kohle agent bekommt ja nur geld wenn er produziert und dann aber die marginalen kosten die in dem moment gelten.
        #z.b. wenn der kohle agent die höchsten marginalen kosten hat ist der profit 0 wenn aber noch ein teurerer agent liefert dann wird der profit höher
        #kann ich villeicht mit der liste an marginalen kosten machen
        
        #network.buses_t.marginal_price["Main_bus"]
    ...
    def agent2(self):
        ...
        self.agents["Producer 1"]["data"].loc[self.timestep, "Income"] = self.agents["Producer 1"]["data"].loc[self.timestep, "Income"] + self.agents["Producer 1"]["data"].loc[self.timestep, "Generated_power_total"]*(self.Electricity_cost_pure-self.agents["Producer 1"]["data"].loc[self.timestep, "Marginal_cost"])
        ...
        print(payback)
        print("income * 0.75")
        print(self.agents["Producer 1"]["data"].loc[self.timestep, "Income"] * 0.75)
        
        if payback < self.agents["Producer 1"]["data"].loc[self.timestep, "Income"] * 0.75:
    ...
    def agent3(self):
        ...
        #calculate Income with calculated PyPSA data
        self.agents["Producer 2"]["data"].loc[self.timestep, "Income"] = self.agents["Producer 2"]["data"].loc[self.timestep, "Income"] + self.agents["Producer 2"]["data"].loc[self.timestep, "Generated_power_total"]*(self.Electricity_cost_pure-self.agents["Producer 2"]["data"].loc[self.timestep, "Marginal_cost"])
        ...
        print(payback)
        print("income * 0.75")
        print(self.agents["Producer 2"]["data"].loc[self.timestep, "Income"] * 0.75)
        
        if payback < self.agents["Producer 2"]["data"].loc[self.timestep, "Income"] * 0.75:
    ...
    def agent4(self):
        ...
        #calculate Income with calculated PyPSA data
        self.agents["Producer 3"]["data"].loc[self.timestep, "Income"] = self.agents["Producer 3"]["data"].loc[self.timestep, "Income"] + self.agents["Producer 3"]["data"].loc[self.timestep, "Generated_power_total"]*(self.Electricity_cost_pure-self.agents["Producer 3"]["data"].loc[self.timestep, "Marginal_cost"])
        ...
        print(payback)
        print("income * 0.75")
        print(self.agents["Producer 3"]["data"].loc[self.timestep, "Income"] * 0.75)
        
        if payback < self.agents["Producer 3"]["data"].loc[self.timestep, "Income"] * 0.75:
    ...
    def agent6(self):
        ...
        #calculate Income with calculated PyPSA data
        self.agents["Producer 5"]["data"].loc[self.timestep, "Income"] = self.agents["Producer 5"]["data"].loc[self.timestep, "Income"] + self.agents["Producer 5"]["data"].loc[self.timestep, "Generated_power_total"]*self.Electricity_cost_pure
        ...
        print(payback)
        print("income * 0.75 5:")
        print(self.agents["Producer 5"]["data"].loc[self.timestep, "Income"] * 0.75)
        
        if payback < self.agents["Producer 5"]["data"].loc[self.timestep, "Income"] * 0.75:
    ...
    def agent7(self):
        ...
        #calculate Income with calculated PyPSA data
        self.agents["Producer 6"]["data"].loc[self.timestep, "Income"] = self.agents["Producer 6"]["data"].loc[self.timestep, "Income"] + self.agents["Producer 6"]["data"].loc[self.timestep, "Generated_power_total"]* (self.Electricity_cost_pure + self.Governmental_funding)
        ...
        print(payback)
        print("Income * 0.75 6")
        print(self.agents["Producer 6"]["data"].loc[self.timestep, "Income"] * 0.75)
        
        if payback < self.agents["Producer 6"]["data"].loc[self.timestep, "Income"] * 0.75:
